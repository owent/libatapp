...
namespace atapp {
    ...
    struct LIBATAPP_MACRO_API_HEAD_ONLY rapidsjon_loader_load_options {
        ...
        inline rapidsjon_loader_load_options(): reserve_empty(false), convert_large_number_to_string(false), string_mode(rapidsjon_loader_string_mode::RAW) {}
    };
    ...
    LIBATAPP_MACRO_API std::string rapidsjon_loader_stringify(const ATBUS_MACRO_PROTOBUF_NAMESPACE_ID::Message& src, const rapidsjon_loader_load_options& options = rapidsjon_loader_load_options());
    LIBATAPP_MACRO_API bool rapidsjon_loader_parse(ATBUS_MACRO_PROTOBUF_NAMESPACE_ID::Message& dst, const std::string& src, const rapidsjon_loader_dump_options& options = rapidsjon_loader_dump_options());

    template<typename TVAL>
    LIBATAPP_MACRO_API_HEAD_ONLY void rapidsjon_loader_mutable_set_member(rapidjson::Value& parent, const char* key, TVAL&& val, rapidjson::Document &doc);
    ...
    LIBATAPP_MACRO_API void rapidsjon_loader_dump_to(const rapidjson::Document& src, ATBUS_MACRO_PROTOBUF_NAMESPACE_ID::Message& dst, const rapidsjon_loader_dump_options& options = rapidsjon_loader_dump_options());

    LIBATAPP_MACRO_API void rapidsjon_loader_load_from(rapidjson::Document& dst, const ATBUS_MACRO_PROTOBUF_NAMESPACE_ID::Message& src, const rapidsjon_loader_load_options& options = rapidsjon_loader_load_options());

    LIBATAPP_MACRO_API void rapidsjon_loader_dump_to(const rapidjson::Value& src, ATBUS_MACRO_PROTOBUF_NAMESPACE_ID::Message& dst, const rapidsjon_loader_dump_options& options = rapidsjon_loader_dump_options());

    LIBATAPP_MACRO_API void rapidsjon_loader_load_from(rapidjson::Value& dst, rapidjson::Document& doc, const ATBUS_MACRO_PROTOBUF_NAMESPACE_ID::Message& src, const rapidsjon_loader_load_options& options = rapidsjon_loader_load_options());
