...
namespace atapp {
    ...
    public:
        ...
        LIBATAPP_MACRO_API const char *name() UTIL_CONFIG_NOEXCEPT UTIL_CONFIG_OVERRIDE;
        LIBATAPP_MACRO_API uint32_t get_address_type(const atbus::channel::channel_address_t &addr) const UTIL_CONFIG_OVERRIDE;
        LIBATAPP_MACRO_API int32_t on_start_listen(const atbus::channel::channel_address_t &addr) UTIL_CONFIG_OVERRIDE;
        ...
        LIBATAPP_MACRO_API int32_t on_close_connect(atapp_connection_handle &handle) UTIL_CONFIG_OVERRIDE;
        LIBATAPP_MACRO_API int32_t on_send_forward_request(atapp_connection_handle *handle, int32_t type, uint64_t *msg_sequence,
                                                                   const void *data, size_t data_size,
                                                                   const atapp::protocol::atapp_metadata *metadata) UTIL_CONFIG_OVERRIDE;
