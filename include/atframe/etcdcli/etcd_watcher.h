...
namespace atapp {
    ...
    public:
        ...
        static LIBATAPP_MACRO_API ptr_t create(etcd_cluster &owner, const std::string &path, const std::string &range_end = "+1");
        ...
        UTIL_FORCEINLINE const std::chrono::system_clock::duration &get_conf_retry_interval() const { return rpc_.retry_interval; }
        ...
        UTIL_FORCEINLINE const std::chrono::system_clock::duration &get_conf_request_timeout() const { return rpc_.request_timeout; }
