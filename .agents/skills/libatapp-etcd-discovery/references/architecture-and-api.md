# etcd Architecture and API Reference

Read this file when changing etcd client, discovery, keepalive, watcher, module, or serialization behavior. Verify
signatures and examples against the current headers and implementations before editing.

## Contents

- [Overview](#overview)
- [Architecture](#architecture)
- [etcd cluster client](#etcd-cluster-client-etcd_cluster)
- [Discovery node and set](#discovery-node-etcd_discovery_node)
- [Keepalive and watcher](#etcd-keepalive-etcd_keepalive)
- [etcd module](#etcd-module-etcd_module)
- [etcd packer](#etcd-packer-etcd_packer)
