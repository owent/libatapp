...
macro(PROJECT_LIBATAPP_LIBRESSL_IMPORT)
    if(LIBRESSL_FOUND)
        ...
        if (TARGET LibreSSL::TLS)
            list(APPEND PROJECT_LIBATAPP_CRYPT_LINK_NAME LibreSSL::TLS)
            list(APPEND PROJECT_LIBATAPP_PUBLIC_LINK_NAMES LibreSSL::TLS)
        else()
            if (LIBRESSL_INCLUDE_DIR)
                list(APPEND PROJECT_LIBATAPP_PUBLIC_INCLUDE_DIRS ${LIBRESSL_INCLUDE_DIR})
            endif ()

            if(LIBRESSL_LIBRARIES)
                list(APPEND PROJECT_LIBATAPP_CRYPT_LINK_NAME ${LIBRESSL_LIBRARIES})
                list(APPEND PROJECT_LIBATAPP_PUBLIC_LINK_NAMES ${LIBRESSL_LIBRARIES})
            endif()
        endif ()
    endif ()
endmacro()
...
if (NOT PROJECT_LIBATAPP_CRYPT_LINK_NAME)
    ...
    if (VCPKG_TOOLCHAIN)
        ...
        PROJECT_LIBATAPP_LIBRESSL_IMPORT()
    endif ()
