...
if(NOT TARGET zstd::libzstd_shared
  ...
  if(NOT TARGET zstd::libzstd_shared
     ...
     AND NOT TARGET zstd::libzstd
     AND NOT TARGET zstd::zstd)
    set(3RD_PARTY_ZSTD_DEFAULT_VERSION "v1.4.9")
    ...
    findconfigurepackage(
      ...
      SRC_DIRECTORY_NAME
      "zstd-${3RD_PARTY_ZSTD_DEFAULT_VERSION}"
      PROJECT_DIRECTORY
      "${PROJECT_3RD_PARTY_PACKAGE_DIR}/zstd-${3RD_PARTY_ZSTD_DEFAULT_VERSION}/build/cmake"
      BUILD_DIRECTORY
      "${CMAKE_CURRENT_BINARY_DIR}/deps/zstd-${3RD_PARTY_ZSTD_DEFAULT_VERSION}/build_jobs_${PROJECT_PREBUILT_PLATFORM_NAME}"
      GIT_BRANCH
      "${3RD_PARTY_ZSTD_DEFAULT_VERSION}"
      GIT_URL
